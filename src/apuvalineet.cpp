...
// Seuraavat kaksi olivat asetuksissa. Siirsin ne tähän, koska static metodit px2nm ja nm2px
// käyttivät niitä. Näiden rutiinien täytyisi olla lähempänä tietoa siitä mikä visualisointi on,
// ts. PeliView:ssä. Toisaalta staattista Asetukset-luokkaa ei enää ole. 
